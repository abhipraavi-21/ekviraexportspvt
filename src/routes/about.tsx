...
import { Check, Sprout, Globe2, Handshake, Leaf, ArrowRight, ShieldCheck, Award, Truck, FileText } from "lucide-react";
...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Your trusted agri trading partner — bridging Indian farms with global markets." },
    ],
  }),
  component: AboutPage,
});
...
const checklist = [
  { icon: ShieldCheck, label: "APEDA & FSSAI Compliant", desc: "Fully registered for international trade and food safety standards." },
  { icon: Truck, label: "Farm-to-Port Coordination", desc: "Seamless logistics from sourcing villages to shipping ports." },
  { icon: FileText, label: "Transparent Documentation", desc: "Complete export paperwork, COO, phyto, and quality certificates." },
  { icon: Award, label: "Reliable Quality Control", desc: "Multi-stage inspection at sourcing, packing, and dispatch." },
];

const values = [
  { icon: Sprout, title: "Rooted in India", desc: "Direct relationships with farmers and APEDA-registered suppliers across Maharashtra and beyond." },
  { icon: Globe2, title: "Built for the World", desc: "Trade corridors focused on the Middle East with growing reach into adjacent global markets." },
  { icon: Handshake, title: "Trade as Partnership", desc: "Long-term relationships with buyers — not one-off shipments. Trust is our default." },
  { icon: Leaf, title: "Quality at Every Step", desc: "From the soil it grew in to the container it ships in — quality is non-negotiable." },
];
      ...
      <main className="flex-1">
          ...
          <div className="max-w-7xl mx-auto px-5 md:px-8 pt-16 md:pt-24 pb-12 md:pb-16 grid lg:grid-cols-2 gap-14 items-start">
            <div>
              ...
              <h1 className="mt-6 font-serif text-4xl md:text-5xl lg:text-6xl leading-[1.05] text-foreground">
                Your Trusted{" "}
                <span className="italic text-primary">Agri Trading</span>{" "}
        ...
        <section className="max-w-7xl mx-auto px-5 md:px-8 py-16 md:py-20">
          <div className="max-w-2xl">
            <span className="text-xs uppercase tracking-[0.22em] text-primary font-medium">Our Approach</span>
        ...
        <section className="max-w-7xl mx-auto px-5 md:px-8 py-16 md:py-20">
          <div className="rounded-3xl bg-card border border-border/60 soft-shadow-lg p-10 md:p-14 text-center">
            ...
            <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
              Tell us what you need — we'll source it, certify it, and ship it from India to your door.
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Button asChild size="lg" className="rounded-full bg-gold text-gold-foreground hover:bg-gold/90 px-6 h-12">
                <a href="mailto:hello@ekviraexport.com">Get a Quote <ArrowRight className="h-4 w-4" /></a>
              </Button>
              <Button asChild size="lg" variant="outline" className="rounded-full border-primary text-primary hover:bg-primary hover:text-primary-foreground px-6 h-12">
